...
#if defined(WIN32) || defined(_WIN32_WCE) || defined(__OBJC__) /*visual studio and xcode*/
...
/*disables VRML/BIFS scene graphs*/ /* REQUIRED FROM RAW->MP4 */
...
/*disables all media import functions*/ /* REQUIRED FROM RAW->MP4 */
//#define GPAC_DISABLE_MEDIA_IMPORT

/*disable all AV parsing functions*/ /* REQUIRED FROM RAW->MP4 */
...
/*disables all ISO FF*/ /* REQUIRED FROM RAW->MP4 */
//#define GPAC_DISABLE_ISOM

/*disables ISO FF hint tracks*/
#define GPAC_DISABLE_ISOM_HINTING

/*disables ISO FF writing*/ /* REQUIRED FROM RAW->MP4 */
//#define GPAC_DISABLE_ISOM_WRITE

/*disables ISO FF fragments*/  /* REQUIRED FROM RAW->MP4 */
